...
const Logger = require('protoo-client/lib/Logger');
const EnhancedEventEmitter = require('protoo-client/lib/EnhancedEventEmitter');
const Message = require('protoo-client/lib/Message');
...
class WebSocketTransport extends EnhancedEventEmitter
{
	...
	_newWebsocket(url, subprotocol, origin, headers, requesteOptions, clientConfig) {
...
class BrowserWebSocketTransport extends WebSocketTransport {
    constructor(url, options)
	{
        super(url, options);
    }
    ...
    _newWebsocket() {
        ...
        return new BrowserWebSocket(this._url, WS_SUBPROTOCOL);
    }
}

module.exports = BrowserWebSocketTransport;